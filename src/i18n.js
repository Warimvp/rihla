...
const fr = {
  ...
  guide: {
    ...
    sections: [
      { t: 'Les étapes et les visas', d: 'Chaque destination compte 9 étapes : 6 de vocabulaire (niveau 1), 3 de vraies phrases (niveau 2). Une étape est validée à partir de 75 % de bonnes réponses. Termine les 9 et tu décroches le visa de la ville, tamponné dans ton passeport.' },
      ...
      { t: 'L’étape du jour', d: 'Un défi quotidien de 10 questions mélangeant les 10 langues — le même tirage pour tout le monde. La première réussite du jour fait avancer ta série.' },
...
const ar = {
  ...
  guide: {
    ...
    ouvrir: 'دليل المسافر',
    sections: [
      { t: 'المراحل والتأشيرات', d: 'كل وجهة فيها 9 مراحل: 6 للمفردات (المستوى 1) و3 لجمل حقيقية (المستوى 2). تُعتمد المرحلة ابتداءً من 75٪ من الإجابات الصحيحة. أكمل التسعة لتنال تأشيرة المدينة في جواز سفرك.' },
      ...
      { t: 'مرحلة اليوم', d: 'تحدٍّ يومي من 10 أسئلة يخلط اللغات العشر — نفس الأسئلة للجميع. أول إنجاز في اليوم يقدّم سلسلتك.' },
