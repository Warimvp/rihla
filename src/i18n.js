...
const fr = {
  ...
  guide: {
    ...
    sections: [
      { t: 'Les étapes et les visas', d: 'Chaque destination compte 12 étapes : 6 de vocabulaire (niveau 1), 3 de conversation (niveau 2), 3 de récits (niveau 3). Une étape est validée à partir de 75 % de bonnes réponses. Termine les 12 et tu décroches le visa de la ville, tamponné dans ton passeport.' },
...
const ar = {
  ...
  guide: {
    ...
    ouvrir: 'دليل المسافر',
    sections: [
      { t: 'المراحل والتأشيرات', d: 'كل وجهة فيها 12 مرحلة: 6 للمفردات (المستوى 1) و3 للمحادثة (المستوى 2) و3 للحكايات (المستوى 3). تُعتمد المرحلة ابتداءً من 75٪ من الإجابات الصحيحة. أكمل الاثنتي عشرة لتنال تأشيرة المدينة في جواز سفرك.' },
