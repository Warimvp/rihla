...
const fr = {
  ...
  guide: {
    ...
    sections: [
      ...
      { t: 'Les exercices', d: 'Dans une étape : d’abord les cartes-mots (touche pour retourner, écoute la prononciation), puis le quiz qui alterne compréhension, écoute pure, production et épellation à tuiles — et, un tour sur deux, la lecture de l’écriture (retrouver la prononciation d’un mot écrit) et l’image (retrouver le mot d’après un dessin, sans passer par la traduction). Chaque mot et chaque phrase se réécoute autant de fois que tu veux — la tortue le redit lentement — et, une fois la réponse révélée, le haut-parleur apparaît sur toutes les questions. L’écoute dépend des voix installées sur ton téléphone : sans voix pour une langue, l’app préfère se taire plutôt que de la prononcer de travers — l’exercice d’écoute et le jeu L’Oreille s’effacent alors pour cette destination.' },
...
const ar = {
  ...
  guide: {
    ...
    sections: [
      ...
      { t: 'التمارين', d: 'في كل مرحلة: بطاقات الكلمات أولاً (اضغط لقلبها واستمع للنطق)، ثم اختبار يناوب بين الفهم والاستماع والإنتاج والتهجئة بالحروف — ومرة كل جولتين، قراءة الكتابة (استرجاع نطق كلمة مكتوبة) والصورة (استرجاع الكلمة من رسم، دون المرور بالترجمة). يمكنك إعادة الاستماع إلى كل كلمة وكل جملة كلما شئت — والسلحفاة تعيدها ببطء — وبعد كشف الجواب يظهر مكبّر الصوت في كل الأسئلة. الاستماع يعتمد على الأصوات المثبتة في هاتفك: إن لم يوجد صوت للغة ما، يفضّل التطبيق الصمت على نطقها بشكل خاطئ — فيختفي تمرين الاستماع ولعبة الأذن لتلك الوجهة.' },
